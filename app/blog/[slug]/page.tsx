...
const PRODUCT_TAG_MAP: Record<string, string[]> = {
  'patch cables': ['the-workhorse', 'the-pedalboard-pack'],
  'pedalboard': ['the-workhorse', 'the-pedalboard-pack'],
  'pedalboard setup': ['the-pedalboard-pack', 'the-workhorse'],
  'pedalboard plans': ['the-pedalboard-pack', 'the-workhorse'],
  'cable management': ['the-pedalboard-pack'],
  'organization': ['the-pedalboard-pack'],
  'cable routing': ['the-pedalboard-pack'],
  'guitar pedals': ['the-workhorse'],
  ...
  'signal chain': ['the-workhorse', 'the-stage-cable'],
  'effects order': ['the-workhorse'],
