...
function WebSiteJsonLd() {
  const data = {
    ...
    description:
      'Boutique guitar patch cables and instrument cables hand-soldered in the USA with Mogami wire and Neutrik connectors. Guaranteed forever.',
    publisher: {
      '@type': 'Organization',
      name: 'Liferline',
      url: 'https://liferline.com',
  ...
  const items = products.map((p, i) => {
    ...
    return {
      ...
      item: {
        ...
        image: `https://liferline.com${p.image.src}`,
      ...
      <section id="products" className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
        <div className="mb-12">
          ...
          <p className="section-subheading">
            ...
            and Neutrik connectors. Every one guaranteed forever.
          </p>
        </div>
